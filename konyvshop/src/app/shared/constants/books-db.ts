export const books = [
  {
    ...
    img :  'hullamsir',
    genre: 'krimi',
    description : 'Kardos Júlia, a keszthelyi rendőrség nyomozója éppen túl van élete ügyén. Boldognak és elégedettnek kellene lennie, mégis az egyik gimnáziumi barátjától kölcsönkapott siófoki luxusapartmanban tölti a napjait, és igyekszik számot vetni a múltjával és még inkább a jelenével.\n' +
      ...
      '\n' +
      'SZLAVICSEK JUDIT 1974-ben született Kaposváron. A Pécsi Tudományegyetemen magyar nyelv és irodalom szakon diplomázott, szakdolgozatát a krimi és a szépirodalom kapcsolatáról írta. Később elvégezte a jogi egyetemet is, és jogászként dolgozott. Első krimije 2020-ban jelent meg Légy/ott címmel. Jelenleg a Balatonnál él a családjával.'
  },
  {
    id : '9789639124691',
    title : 'Az új királyság',
    ...
    genre: 'kalandregény',
    img :  'az_uj_kiralysag',
    description : 'Wilbur Smith a következőket írta új könyvéről:\n' +
  ...
  },
  {
    ...
    description : '"Eszes és mesteri." - Entertainment Weekly\n' +
      '\n' +
  ...
  {
    id : '9789634069249',
    title : 'Vaják II. - The Witcher - A végzet kardja',
    author : 'Andrzej Sapkowski',
    publisher : 'Gabo Kiadó',
    year : '2020',
    pages : '422',
    price : '3392',
    genre: 'fantasy',
    img : 'vajak2_vegzet_kardja',
    description : 'Az utolsó kívánság nagy sikerű folytatásában Geralt további novellákban küzd szörnyekkel, démonokkal és emberi gonoszsággal…\n' +
      '\n' +
  ...
  {
    id : '9789634069256',
    title : 'Vaják III. - The Witcher - Tündevér',
    author : 'Andrzej Sapkowski',
    publisher : 'Gabo Kiadó',
    year : '2020',
    pages : '371',
    ...
    genre: 'fantasy',
    img : 'vajak3_tundever',
    description : 'Több mint egy évszázada élnek viszonylagos békében az emberek, törpök és tündék. Az idők azonban változnak, és ahogy az indulatok egyre magasabbra csapnak, ismét vér áztatja a földet.\n' +
  ...
  {
    id : '9789634069263',
    title : 'Vaják IV. - The Witcher - A megvetés ideje',
    author : 'Andrzej Sapkowski',
    publisher : 'Gabo Kiadó',
    year : '2020',
    pages : '402',
    price : '3392',
    genre: 'fantasy',
    img : 'vajak4_megvetes_ideje',
    description : 'Hogy megvédje a rábízott Cirit, Ríviai Geraltnak messzire kell küldenie a vajákok otthonától, hogy Yennefer, a varázslónő szárnyai alatt tanuljon. A varázslógyűlésben azonban puccs készül, miközben kitör a háború. Geralt egy súlyos sérülés után az életéért küzd... Ciri pedig, akinek kezében a világ sorsa nyugszik, eltűnik.\n' +
      '\n' +
      'Andrzej Sapkowski 1948-ban született Lengyelországban. Hazája egyik leghíresebb és legsikeresebb szerzőjének számít. A World Fantasy Életműdíjjal kitüntetett szerző Vaják-sorozatával nemzetközi sikert aratott, könyvei alapján képregények és számítógépes játékok is készültek, 2019-ben pedig a Netflix forgatott belőlük sorozatot Henry Cavill főszereplésével. '
  },
  {
    ...
    genre: 'fantasy',
    img : 'csipkerozsikak',
    description : 'Stephen King és Owen King szuperprodukciójában, apa és fia közösen írt könyvében a fő kérdés: mi történhet, ha a nők eltűnnek a férfiak világából?\n' +
